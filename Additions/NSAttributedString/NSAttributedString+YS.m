//
//  NSAttributedString+YS.m
//  ZFB
//
//  Created by yaoshuai on 16/7/16.
//  Copyright © 2016年 ys. All rights reserved.
//

#import "NSAttributedString+YS.h"

@implementation NSAttributedString (YS)

+ (instancetype)ys_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
