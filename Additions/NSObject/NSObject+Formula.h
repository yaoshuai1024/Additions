 ...
 *  @return 开始、结束值组成的结构体
 */
static inline YSValue YSValueMake(CGFloat startValue, CGFloat endValue)
{
    YSValue value;
 ...
 *  @return 结果指
 */
+ (CGFloat)ys_resultWithConsult:(CGFloat)consule andResultValue:(YSValue)resultValue andConsultValue:(YSValue)consultValue;
