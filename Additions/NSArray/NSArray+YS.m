...
+ (instancetype)ys_arrayWithURL:(NSURL *)url andModelClassName:(NSString *)modelClassName
{
    NSArray *arr = [NSArray arrayWithContentsOfURL:url];
    NSMutableArray *marr = [NSMutableArray arrayWithCapacity:arr.count];
    for (NSDictionary *dict in arr) {
        [marr addObject:[NSObject ys_objWithClassName:modelClassName andDictionary:dict]];
    }
    return marr.copy;
}
